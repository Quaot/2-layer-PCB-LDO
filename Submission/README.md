...
The minimum current flowing out of Vout for it to continue regulating is 5 mA, according to pg. 6 of LM1117 datasheet. 5 mA was used as it is the minimum current that must flow out of Vout in order for it to continue regulating at a range of temp 0–125 °C.
...
**See LM1117 Divider Calculator.xlsx** in "Calcalations" folder for more detailed calculations as to why specific values for R1 and R2 were chosen. (Specifically 162 ohm & 267 ohm for R1 and R2 respectively).

# Decision for the resistor divider passives

2 resistors, (162 and 267 ohm respectively) were chosen based on the **LM1117 Divider Calculator.xlsx**
